...
import pspcode.com.lwjgl.monitor.LwjglVideo;
import pspcode.com.physics2d.Physics2D;
import pspcode.com.scenes.Scene;
import pspcode.com.scenes.SceneInitializer;
...
public class LwjglWindow implements LwjglVideo, Observer {
	...
	/** LwjglWindow is the main class to create the window
	 * in your application, followed by {@code LwjglVideo}
	 * & {@code LwjglConfig}
	 * 
	 * @param config is the window configuration to runs it		
	 * @function run the window */
	...
	private void run(int width, int height, String title) {
		// System.out.println("Hello PSP " + Version.getVersion() + "!");
